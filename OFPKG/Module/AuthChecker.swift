...
@objcMembers class AuthChecker : NSObject{
    class func checkCameraPermission(reusltHandler:@escaping (Bool)->()) {
    ...
    class func checkPhotoLibraryPermission(reusltHandler:@escaping (Bool)->()) {
    ...
    class func alertGoSettingsWithTitle(title: String, message: String){
