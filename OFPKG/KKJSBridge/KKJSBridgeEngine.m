...
- (void)setupJSBridge {
    ...
    NSString *bridgeJSString = [[NSString alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:bridgeJSName ofType:@"js"] encoding:NSUTF8StringEncoding error:NULL];
    ...
    NSString *baseFunctionJSString = [[NSString alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"BaseFunction" ofType:@"js"] encoding:NSUTF8StringEncoding error:NULL];
