...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DFBaseLib/DFBaseLib.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DFOCBaseLib/DFOCBaseLib.framework"
  install_framework "${PODS_ROOT}/DFToGameLib/DFToGameLib/Frameworks/HMCloudPlayerCore.framework"
  install_framework "${PODS_ROOT}/DFToGameLib/DFToGameLib/Frameworks/HMWebRTC.framework"
