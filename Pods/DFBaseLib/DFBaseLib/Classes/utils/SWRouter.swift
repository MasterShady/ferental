...
public class RouterUtil {
    ...
    public class func currentTopViewController(rootViewController:UIViewController) -> UIViewController {
        ...
        if rootViewController.presentingViewController != nil {
            return currentTopViewController(rootViewController: rootViewController.presentingViewController!)
        }
...
//          let topViewController = RouterUtil.currentTopViewController()
