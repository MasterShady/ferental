...
- (void)showActionImage:(NSString *)imageName {
    ...
    NSString *gifImagePath = [DFFileUtil filePathWithName:[NSString stringWithFormat:@"%@.gif",imageName] withBundleName:DFNeteasySourceBundle];
...
- (void)playActionMusic:(NSString *)musicName {
    // 0——正面，1——右转，2——左转，3——张嘴，4——眨眼
    NSString *fileUrl = [DFFileUtil filePathWithName:[NSString stringWithFormat:@"%@.wav",musicName] withBundleName:DFNeteasySourceBundle];
