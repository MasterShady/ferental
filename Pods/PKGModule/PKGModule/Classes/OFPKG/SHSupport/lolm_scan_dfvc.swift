 ...
 */
@available(iOS 11.0, *)
@objcMembers public class lolm_scan_dfvc: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    public var lolp_qrcodeOutBlock:((String?)->())?
...
//        navLeftItemBtnImageName = "nav_back_white"
        ...
        //监听 app 从后台返回前台，重新扫描
        NotificationCenter.default.addObserver(self, selector: #selector(sessionStartRunning(notificaiton:)), name: NSNotification.Name(rawValue: "fix"), object: nil)
        //开始动画
        self.performSelector(onMainThread: #selector(timerFired), with: nil, waitUntilDone: false)
            //判断相机权限
    ...
    lazy var lolp_scanImageView:UIImageView = {
        ...
        scanImageView.image = .init(named: "scan_bg_icon", in: PKGUICinfig.bundle, with: nil)
    ...
    lazy var lolp_activeImageView:UIImageView = {
        ...
        let image = UIImage(named: "active_line_icon", in: PKGUICinfig.bundle, with: nil)
