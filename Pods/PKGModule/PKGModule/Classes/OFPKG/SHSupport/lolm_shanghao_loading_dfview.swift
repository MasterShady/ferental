...
class lolm_shanghao_loading_dfview: UIView {
    ...
    lazy var lolmp_animationView:AnimationView = {
        ...
        let view = AnimationView.init(name: "lolm_tb_game", bundle: PKGUICinfig.bundle)
    ...
    lazy var closeBtn:UIButton = {
        ...
        btn.setImage(UIImage.init(named: "left_back", in: PKGUICinfig.bundle, with: nil), for: .normal)
